...
@Composable
fun CameraSensorStatusScreen(
    connectionStatus: Boolean,
    testingTime: LocalDateTime
) {
    CameraSensorStatusContent(
...
@Composable
fun CameraSensorStatusPreview() {
    CameraSensorStatusScreen(true, LocalDateTime.now())
}